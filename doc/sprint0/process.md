...
# Prioritizing and Estimation 
In the upcoming Sprint, stores that are core and fundamental to our project will be assigned the highest priority. For example, user registration will have the highest priority because you need to be logged in to make use of most features.

For estimating points, we will look at the user story as a group, bring out possible pain points and difficulties we could encounter as we implement the story. Then finally vote on an amount of story points that should be assigned.  
